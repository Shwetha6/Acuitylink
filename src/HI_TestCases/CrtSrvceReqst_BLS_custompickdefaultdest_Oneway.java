...
public class CrtSrvceReqst_BLS_custompickdefaultdest_Oneway extends HI_Login
{
	WebDriver driver;
...
Reporter.log("Service request successfully created pop up is displayed(BLS)using custom pick up and default destinaion(One-way)", true);
Thread.sleep(3000);
driver.findElement(By.xpath("//button[@class='btn btn-primary'][contains(text(), 'OK')]")).click();
