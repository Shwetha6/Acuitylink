...
public class CrtSrvceReqst_BLS_defaultpickcustomdest_Oneway extends HI_Login
{
	WebDriver driver;
	...
	Reporter.log("Service request successfully created pop up is displayed(BLS) with default pick up and custom destination(One-way)", true);
	Thread.sleep(3000);
	driver.findElement(By.xpath("//button[@class='btn btn-primary'][contains(text(), 'OK')]")).click();
		}
		catch (Exception e) 
