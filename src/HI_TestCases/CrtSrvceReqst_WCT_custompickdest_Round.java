...
public class CrtSrvceReqst_WCT_custompickdest_Round extends HI_Login
{
	WebDriver driver;
	...
	@Test
	public void HiFillPatientInformationWCTRoundTripcustompickdest()
	{
		try
		{
			
			HI_Login w3 = new HI_Login();
			driver = w3.hiLogin();
